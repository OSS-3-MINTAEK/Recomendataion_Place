...
Label(window,text="카 페:").grid(row=3,column=0)
Label(window,text="음식점:").grid(row=4,column=0)
Label(window,text="관광지:").grid(row=5,column=0)
Label(window,text="숙 소:").grid(row=6,column=0)
...
Button(window,text="변경").grid(row=6,column=2)
window.mainloop()